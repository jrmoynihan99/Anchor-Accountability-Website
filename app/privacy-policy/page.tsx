        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 md:p-12 space-y-8 text-white/80">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 leading-relaxed">
              ...
              <li>
                Anonymous messages, encouragement, posts, and all other
                user-generated content
              </li>
              <li>
                Organization membership (if you join through a church or
                organization, purely to enable correct app function)
              </li>
            </ul>
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              When you join through a church or organization:
            </p>
            <ul className="list-disc pl-6 space-y-2 leading-relaxed">
              <li>
                Your interactions are with members of your organization only
              </li>
              <li>
                You remain fully anonymous - we don&apos;t collect or link your
                real identity
              </li>
              <li>
                Organization administrators have no access to individual account
                information or activity
              </li>
              <li>
                Your anonymity is preserved; you&apos;re simply part of a
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              are moderated using OpenAI&apos;s API. The API has no context in
